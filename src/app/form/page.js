...
import { Building, Globe, Mail, Phone, User, Users, Briefcase, MapPin, FileText, Shield, Award, Upload, CheckCircle, ArrowRight, ArrowLeft, Save, Send, Info, AlertCircle, HelpCircle } from 'lucide-react'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const formSchema = z.object({
  ...
  companyDescription: z.string().min(50, { message: "Description must be at least 50 characters" }).max(500, { message: "Description must not exceed 500 characters" }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    50-500 characters. This will be displayed on your vendor profile.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600">Provide details of the primary contact person for this application.</p>
            </div>
            ...
            <Alert className="bg-blue-50 border-blue-100">
              ...
              <AlertDescription className="text-blue-700 text-sm">
                Your contact information will only be used for communication regarding your vendor application and will not be shared with third parties.
              </AlertDescription>
            </Alert>
          </div>
        );
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This is the main category your company will be listed under.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    ...
                    <FormDescription>
                      Select the industries your solutions primarily serve.
                    </FormDescription>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {industries.map((item) => (
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    ...
                    <FormDescription>
                      Select the regions where you provide your services.
                    </FormDescription>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {regions.map((item) => (
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    ...
                    <FormDescription>
                      Select the client sizes your company typically serves.
                    </FormDescription>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        Are you willing to provide client references upon request?
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600">Provide additional details about your value proposition and competitive advantage.</p>
            </div>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-slate-50">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        I agree to the <a href="#" className="text-blue-600 hover:underline">Vendor Terms and Conditions</a> and confirm that all information provided is accurate and complete.
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 mt-4">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        I consent to receive marketing communications from TechSoss about vendor opportunities, events, and platform updates.
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 mb-8 max-w-md mx-auto">
          Thank you for applying to become a TechSoss vendor. Our team will review your application and contact you within 3-5 business days.
        </p>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm mb-4">
                  If you have any questions about the application process or need assistance, our vendor support team is here to help.
                </p>
